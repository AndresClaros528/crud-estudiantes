...
<div class="container " > 
    <div class="row content">
        <a href="index.php"  class="button button-purple mt-12 pull-right">Listado de Estudiantes</a> 
        <h3>Actulizar informacion del estudiante</h3>
        <?php
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" name="student_name" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" required value="<?php if (isset($student_info['student_name'])) {
                   echo $student_info['student_name'];
        } ?>" id="student_name" class="form-control" required maxlength="50">
            </div>
            <div class="form-group">
                <label for="email_address">Correo/Email:</label>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" value="<?php if (isset($student_info['contact'])) {
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="gender" id="gender">
                    ...
                    <option value="Hombre" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'Hombre') {
            echo 'selected';
        } ?>>Hombre</option>
                    <option value="Female" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'Female') {
            echo 'selected';
        } ?>>Mujer</option>
                    <option value="Undefined" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'Undefined') {
            echo 'selected';
        } ?>>Indefinido</option>
            ...
            <input type="submit" class="button button-green  pull-right" name="update_student" value="Actulizar"/>
        </form> 
    </div>
</div>
<hr/>
